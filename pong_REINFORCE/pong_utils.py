...
def collect_trajectories(envs, policy, tmax=200, nrand=5):
    ...
    for t in range(tmax):
        ...
        # Take a random action, namely, out of the vector, choose a random one to be RIGHT, and all the rest is LEFT
        # Example: 
        # old probs: [0.4720374 0.4720374 0.4720374 0.4720374]
        # action: [4 5 5 5]
        # old probs updated: [0.4720374  0.52796257 0.52796257 0.52796257]
...
# Choose the actions that are predicted by the policy
