...
def run(env, brain_name):
    ...
    gamma = 0.99
    batch_size = 64
    agent = Agent(lr, gamma, batch_size, state_shape, action_size)
    ...
    for episode in range(1, nepisodes + 1):
        ...
        while True:
            ...
            for idx in range(0, 3):
                ...
                sequence_of_frames.append(next_state)
            ...
            agent.train(sequence_of_frames, action, reward, next_state, done)
