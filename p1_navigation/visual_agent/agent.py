...
class Agent:
    ...
    def __init__(self, lr, gamma, batch_size, state_shape, action_size):
        self.lr = lr
        self.gamma = gamma
        ...
        self.behavioral_model = Model(seed, self.width, self.height, self.input_channels, action_size).cuda()
        self.target_model = Model(seed, self.width, self.height, self.input_channels, action_size).cuda()
